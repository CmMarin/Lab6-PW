...
<div class="flex flex-col gap-3 p-1">
    {#each games as game}
        <div class="card p-4 flex items-center gap-6 group hover:-translate-x-1 transition-transform border-[var(--accent)]/0 hover:border-[var(--accent)] border-l-4">
            <div class="w-16 h-16 bg-border/10 rounded overflow-hidden flex-shrink-0">
                <model-viewer src={game.modelUrl} auto-rotate disable-zoom interaction-prompt="none" class="w-full h-full scale-125" />
            </div>
